...
length(outcome_F1$SNP) #Number of SNPs included  = 1096627
...
- quality control involves selecting only significant genome-wide significant p-values for loneliness, clumping and harmonizing the data
...
```r
#running MR
(MR_lonelinesstoF1 <- mr(DataMR_lonelinesstoF1))
...
```r
Results_lonelinesstoF1_heterogeneity <- mr_heterogeneity(DataMR_lonelinesstoF1)
Results_lonelinesstoF1_heterogeneity 
```
Pleiotropy test
```r
Results_lonelinesstoF1_pleiotropy <- mr_pleiotropy_test(DataMR_lonelinesstoF1)
...
```r
DataMR_lonelinesstoF1_leaveOut_egger<- mr_leaveoneout(DataMR_lonelinesstoF1, method = mr_egger_regression) # Default: ivw method
...
DataMR_lonelinesstoF1k <- DataMR_lonelinesstoF1[abs(DataMR_lonelinesstoF1$beta.exposure) < quantile(abs(DataMR_lonelinesstoF1$beta.exposure), 0.20), ] 
...
length(DataMR_lonelinesstoF1k_keep$SNP) # 25 variants selected. Note that a very small number for MR Egger (e.g. 8) yield completely unstable estimates.
...
(isqldl <- Isq(y = DataMR_lonelinesstoF1k$beta.exposure, s = DataMR_lonelinesstoF1k$se.exposure))# Very high (95.6%) many strong variants, so not much to correct for

#Calculate I2 (I squared) - include only weak instruments
(isqldl_w <- Isq(DataMR_lonelinesstoF1k$beta.exposure/DataMR_lonelinesstoF1k$se.outcome, DataMR_lonelinesstoF1k$se.exposure/DataMR_lonelinesstoF1k$se.outcome))# Very close
...
DataMR_lonelinesstoF1_Steiger #says correct causal direction and highly sig (loneliness to F1)

# We can apply the test on one SNP
DataMR_lonelinesstoF1_Steiger <- directionality_test(DataMR_lonelinesstoF1[1, ])
# As can be seen the r2 for the exposure is much bigger than for the outcome
DataMR_lonelinesstoF1_Steiger$snp_r2.exposure/DataMR_lonelinesstoF1_Steiger$snp_r2.outcome #effect on the exposure 48.7 times bigger

#Loop over all SNPs
SteigerSNPs= matrix(nrow = dim(DataMR_lonelinesstoF1)[1], ncol = 8) 
for (i in 1:dim(DataMR_lonelinesstoF1)[1]){
  temp  <- directionality_test(DataMR_lonelinesstoF1[i, ])
...
DataMR_lonelinesstoF1$r.exposure =
  get_r_from_pn(n = DataMR_lonelinesstoF1$samplesize.exposure,
                p = DataMR_lonelinesstoF1$pval.exposure)

DataMR_lonelinesstoF1$r.outcome =
  get_r_from_pn(n = 184305,
                p = DataMR_lonelinesstoF1$pval.outcome)
#and recalculate Steiger
SteigerSNPs1 = matrix(nrow = dim(DataMR_lonelinesstoF1[1],ncol = 8) 
for (i in 1:dim(DataMR_lonelinesstoF1)[1]){
  temp  <- directionality_test(DataMR_lonelinesstoF1[i, ])
...
names(SteigerSNPs1) = names(DataMR_lonelinesstoF1_Steiger)  
...
DataMR_lonelinesstointernalising$r.outcome =
  get_r_from_lor(lor = DataMR_lonelinesstoF1$beta.outcome,
                 af = DataMR_lonelinesstoF1$eaf.outcome,
                 ncase = 60801,
                 ncontrol = 123504,
...
SteigerSNPs2 = matrix(nrow =dim(DataMR_lonelinesstoF1)[1],ncol = 8) 
for (i in 1:dim(DataMR_lonelinesstoF1)[1]){
  temp  <- directionality_test(DataMR_lonelinesstoF1[i, ])
...
names(SteigerSNPs2) = names(DataMR_lonelinesstoF1_Steiger)  
table(SteigerSNPs2$correct_causal_direction)
head(SteigerSNPs2)
# no change in validity of instruments though

DataMR_lonelinesstoF1$correct_causal_direction <- SteigerSNPs2$correct_causal_direction # integrate the correct_causal_direction column into DataMR
DataMR_lonelinesstoF1_Steigerfiltered <- DataMR_lonelinesstoF1[DataMR_lonelinesstoF1$correct_causal_direction == "TRUE",] #create DataMR only with those SNPs
dim(DataMR_lonelinesstoF1_Steigerfiltered) #check that number of rows matches
...
MR_lonelinesstoF1_IVW_Egger_single <- mr_singlesnp(DataMR_lonelinesstoF1, all_method = c("mr_ivw","mr_egger_regression", "mr_weighted_median", "mr_weighted_mode"))
MR_lonelinesstoF1_forest <- mr_forest_plot(MR_lonelinesstoF1_IVW_Egger_single)
MR_lonelinesstoF1_forest[[1]]

#Create scatter plot
MR_lonelinesstoF1_IVW_Egger <- mr(DataMR_lonelinesstoF1, method_list = c("mr_egger_regression", "mr_ivw"))
MR_lonelinesstoF1_IVW_Egger_scatter <- mr_scatter_plot(MR_lonelinesstoF1_IVW_Egger, DataMR_lonelinesstoF1)
MR_lonelinesstoF1_IVW_Egger_scatter[[1]]

# Funnel plot
DataMR_lonelinesstoF1k_single <- mr_singlesnp(DataMR_lonelinesstoF1k, all_method = c("mr_ivw","mr_egger_regression", "mr_weighted_median", "mr_weighted_mode"))
...
# Perform MR-PRESSO
out_presso <- mr_presso(BetaOutcome = "F1", BetaExposure = "loneliness", # define effects of SNPs on exposure and outcome
                        SdOutcome = "F1_se", SdExposure = "loneliness_se", # define standard errors of exposure and outcome
